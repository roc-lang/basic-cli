...
const _SIZE_CHECK_union_IncludeTheseTypes: () = assert!(core::mem::size_of::<union_IncludeTheseTypes>() == 128);
const _ALIGN_CHECK_union_IncludeTheseTypes: () = assert!(core::mem::align_of::<union_IncludeTheseTypes>() == 8);

const _SIZE_CHECK_IncludeTheseTypes: () = assert!(core::mem::size_of::<IncludeTheseTypes>() == 136);
const _ALIGN_CHECK_IncludeTheseTypes: () = assert!(core::mem::align_of::<IncludeTheseTypes>() == 8);
...
impl IncludeTheseTypes {
    ...
    pub fn discriminant(&self) -> discriminant_IncludeTheseTypes {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_IncludeTheseTypes>(*bytes.as_ptr().add(128))
        }
    }

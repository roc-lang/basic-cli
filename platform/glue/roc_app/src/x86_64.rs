...
const _SIZE_CHECK_GlueTypes: () = assert!(core::mem::size_of::<GlueTypes>() == 96);
...
impl GlueTypes {
    ...
    pub fn discriminant(&self) -> discriminant_GlueTypes {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_GlueTypes>(*bytes.as_ptr().add(88))
        }
    }

...
// const _SIZE_CHECK_union_Response: () = assert!(core::mem::size_of::<union_Response>() == 64);
const _ALIGN_CHECK_union_Response: () = assert!(core::mem::align_of::<union_Response>() == 8);

const _SIZE_CHECK_Response: () = assert!(core::mem::size_of::<Response>() == 64);
...
const _SIZE_CHECK_union_GlueTypes: () = assert!(core::mem::size_of::<union_GlueTypes>() == 72);
const _ALIGN_CHECK_union_GlueTypes: () = assert!(core::mem::align_of::<union_GlueTypes>() == 8);

const _SIZE_CHECK_GlueTypes: () = assert!(core::mem::size_of::<GlueTypes>() == 80);
...
impl GlueTypes {
    ...
    pub fn discriminant(&self) -> discriminant_GlueTypes {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_GlueTypes>(*bytes.as_ptr().add(72))
        }
    }

...
const _SIZE_CHECK_union_GlueTypes: () = assert!(core::mem::size_of::<union_GlueTypes>() == 68);
const _ALIGN_CHECK_union_GlueTypes: () = assert!(core::mem::align_of::<union_GlueTypes>() == 4);

const _SIZE_CHECK_GlueTypes: () = assert!(core::mem::size_of::<GlueTypes>() == 72);
...
impl GlueTypes {
    ...
    pub fn discriminant(&self) -> discriminant_GlueTypes {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_GlueTypes>(*bytes.as_ptr().add(68))
        }
    }

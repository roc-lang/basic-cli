...
pub union union_Body {
    pub Body: core::mem::ManuallyDrop<Body_Body>,
    pub EmptyBody: (),
}
...
#[repr(C)]
pub struct Body {
    pub payload: union_Body,
    pub discriminant: discriminant_Body,
}
...
pub struct TimeoutConfig {
    pub payload: union_TimeoutConfig,
    pub discriminant: discriminant_TimeoutConfig,
}

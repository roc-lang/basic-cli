...
cp target/release/libhost.a ./platform/macos-x64.a
cp target/release/libhost.a ./platform/linux-arm64.a
cp target/release/libhost.a ./platform/linux-x64.a
cp target/release/libhost.lib ./platform/windows-arm64.lib
cp target/release/libhost.lib ./platform/windows-x64.lib

...
const _SIZE_CHECK_union_InternalResponse: () = assert!(core::mem::size_of::<union_InternalResponse>() == 112);
const _ALIGN_CHECK_union_InternalResponse: () = assert!(core::mem::align_of::<union_InternalResponse>() == 8);

const _SIZE_CHECK_InternalResponse: () = assert!(core::mem::size_of::<InternalResponse>() == 112);
...
impl InternalResponse {
    ...
    pub fn discriminant(&self) -> discriminant_InternalResponse {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_InternalResponse>(*bytes.as_ptr().add(104))
        }
    }
...
const _SIZE_CHECK_union_Error: () = assert!(core::mem::size_of::<union_Error>() == 32);
const _ALIGN_CHECK_union_Error: () = assert!(core::mem::align_of::<union_Error>() == 8);

const _SIZE_CHECK_Error: () = assert!(core::mem::size_of::<Error>() == 40);
...
impl Error {
    ...
    pub fn discriminant(&self) -> discriminant_Error {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_Error>(*bytes.as_ptr().add(32))
        }
    }
...
const _SIZE_CHECK_union_GetMetadataErr: () = assert!(core::mem::size_of::<union_GetMetadataErr>() == 40);
const _ALIGN_CHECK_union_GetMetadataErr: () = assert!(core::mem::align_of::<union_GetMetadataErr>() == 8);

const _SIZE_CHECK_GetMetadataErr: () = assert!(core::mem::size_of::<GetMetadataErr>() == 40);
const _ALIGN_CHECK_GetMetadataErr: () = assert!(core::mem::align_of::<GetMetadataErr>() == 8);
...
const _SIZE_CHECK_union_ReceiveResult: () = assert!(core::mem::size_of::<union_ReceiveResult>() == 24);
const _ALIGN_CHECK_union_ReceiveResult: () = assert!(core::mem::align_of::<union_ReceiveResult>() == 8);

const _SIZE_CHECK_ReceiveResult: () = assert!(core::mem::size_of::<ReceiveResult>() == 32);
const _ALIGN_CHECK_ReceiveResult: () = assert!(core::mem::align_of::<ReceiveResult>() == 8);
...
impl ReceiveResult {
    ...
    pub fn discriminant(&self) -> discriminant_ReceiveResult {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_ReceiveResult>(*bytes.as_ptr().add(24))
        }
    }
